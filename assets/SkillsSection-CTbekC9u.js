import { L as k, m as l, d as S } from './features-animation-BA_w8hZY.js';
import { j as e, a as g, m as r, r as t, X as x, A as y } from './index-DSexRWl0.js';
				...
				: a >= 60
					...
					: a >= 45
						...
						: a >= 10
							? 'Basic'
							: 'Learning',
	u = t.forwardRef(({ name: a, icon: c, level: n, index: i, desc: s }, o) => {
		const d = v(n),
			[f, p] = t.useState(!1),
			m = () => p(!1);
		return e.jsxs(e.Fragment, {
			children: [
				e.jsxs(r.div, {
					...
					onClick: () => p(!0),
					className: g(
						'relative group flex flex-col items-center gap-3 w-100 h-[140px]',
					...
					children: [
						e.jsx('div', { className: 'text-4xl text-primary/90', children: e.jsx('i', { className: c }) }),
						e.jsx('span', { className: 'text-sm font-semibold text-center leading-tight', children: a }),
						e.jsx('div', {
            ...
            px-2 py-1 text-xs rounded-full\r
            bg-primary/75 text-primary-foreground font-medium\r
            opacity-0 scale-90\r
							...
							children: e.jsxs(r.div, {
								...
								children: [
									e.jsx('button', {
										...
										children: e.jsx(x, { size: 22 }),
									}),
									e.jsx('h2', { className: 'text-2xl font-bold mb-3 text-primary', children: a }),
									e.jsx('p', {
										className: 'text-muted-foreground',
										children: s || 'Bu skill bo‘yicha tavsif hali qo‘shilmagan.',
									}),
									e.jsxs('div', { className: 'mt-4 font-semibold text-primary', children: ['Level: ', n, '% — ', d] }),
								],
							}),
						}),
				}),
...
const j = [
	...
	w = [
		...
		{ name: 'Go', icon: 'devicon-go-plain colored', level: 0, desc: 'Go is fast and scalable.', category: 'backend' },
		{
			name: 'Rust',
...
function I() {
	const [a, c] = t.useState('frontend'),
		[n, i] = t.useState(null),
		s = w.filter(o => a === 'all' || o.category === a);
	return e.jsx(k, {
		features: S,
			...
			children: [
				...
				e.jsx('div', {
					...
					children: e.jsxs('div', {
						...
						children: [
							e.jsx(h, { number: '02', title: 'Skills' }),
							e.jsxs('div', {
								className: 'flex-1 ',
								children: [
									e.jsx(l.h3, {
										...
										children: 'Full Stack Developer Skills',
									}),
									e.jsx(l.div, {
										initial: { opacity: 0, y: 20 },
										whileInView: { opacity: 1, y: 0 },
...
\r
                ...
                overflow-y-auto\r
                overflow-x-hidden\r
								grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 p-4\r
              `,
										children: e.jsx(y, {
											mode: 'popLayout',
											children: s.map((o, d) =>
...
export { I as default, I as SkillsSection };
