import{j as e,r as d}from"./radix-1h7f9VDF.js";import{H as j}from"./heroSection-B2hxNlRD.js";import{L as g,T as N}from"./Index-B2HwmgWl.js";import{a as k,c as I}from"./index-DxHZ3zj3.js";import{m as b,L,d as z,a as r}from"./motion-eszmwozl.js";import{G as y,I as T,S as _}from"./icons-mI2stUsA.js";import{u as H}from"./i18n-Blv0dhYd.js";const S=""+new URL("hero-bg-cX0l4YhF.webp",import.meta.url).href;function h({href:a,icon:o,label:s,platform:t,delay:i=0}){return e.jsxs(e.Fragment,{children:[e.jsx(b.a,{href:a,target:"_blank",rel:"noopener noreferrer","aria-label":s,initial:{opacity:0,y:-15},animate:{opacity:1,y:0},transition:{duration:.4,delay:i},whileTap:{scale:.9},className:k("social-icon",t,"flex h-12 w-12 items-center justify-center rounded-full","border-2 border-transparent bg-[#0f0f0f] text-white","transition-all duration-300 relative overflow-hidden"),children:o}),e.jsx("style",{children:`
        .social-icon {
          background:
      ...
      `})]})}function F({phrases:a,className:o,speed:s=100,deleteSpeed:t=50,pauseTime:i=2e3}){const[c,x]=d.useState(0),[n,f]=d.useState(""),[l,m]=d.useState(!1);return d.useEffect(()=>{if(a.length===0){n&&f(""),l&&m(!1),c!==0&&x(0);return}const p=a[c]??"";let u=null;const w=window.setTimeout(()=>{l?n.length>0?f(n.slice(0,-1)):(m(!1),x(v=>(v+1)%a.length)):n.length<p.length?f(p.slice(0,n.length+1)):u=window.setTimeout(()=>m(!0),i)},l?t:s);return()=>{window.clearTimeout(w),u&&window.clearTimeout(u)}},[n,l,c,a,s,t,i]),e.jsxs("span",{className:I("inline-block",o),children:[n,e.jsx(b.span,{animate:{opacity:[1,0,1]},transition:{duration:.8,repeat:1/0},className:"ml-1 inline-block w-[3px] h-[1em] bg-primary align-middle"})]})}const B=[{href:"https://github.com",icon:e.jsx(y,{className:"h-6 w-6"}),label:"GitHub",platform:"github"},{href:"https://instagram.com",icon:e.jsx(T,{className:"h-6 w-6"}),label:"Instagram",platform:"instagram"},{href:"https://t.me",icon:e.jsx(_,{className:"h-6 w-6"}),label:"Telegram",platform:"telegram"}];function R(){const{t:a}=H(),o=[a("hero.typewriter.name"),a("hero.typewriter.frontend"),a("hero.typewriter.uiux"),a("hero.typewriter.web3")],s=a("hero.greeting");return e.jsxs(L,{features:z,children:[" ",e.jsxs("section",{className:"relative  flex flex-col overflow-hidden bg-background",children:[e.jsx("div",{className:"absolute inset-0 bg-cover bg-center bg-no-repeat opacity-30",style:{backgroundImage:`url(${S})`}}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-background/30 via-background/60 to-background"}),e.jsx("div",{className:"absolute inset-0 opacity-10",children:e.jsx("div",{className:"absolute inset-0",style:{backgroundImage:`linear-gradient(hsl(var(--primary) / 0.1) 1px, transparent 1px),
                              linear-gradient(90deg, hsl(var(--primary) / 0.1) 1px, transparent 1px)`,backgroundSize:"50px 50px"}})}),e.jsxs(r.header,{initial:{opacity:0,y:-50},animate:{opacity:1,y:0},transition:{duration:.6,delay:1.5},className:"relative z-10 flex items-center justify-between p-4 md:p-8",children:[e.jsx(h,{href:"https://github.com",icon:e.jsx(y,{className:"h-6 w-6"}),label:"GitHub",platform:"github",delay:1.6}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"flex gap-2",children:B.slice(1).map((t,i)=>e.jsx(h,{...t,delay:1.7+i*.1},t.label))}),e.jsx(g,{className:"hidden md:flex items-center"}),e.jsx(g,{className:"md:hidden flex items-center"}),e.jsx(N,{})]})]}),e.jsx("div",{className:"relative z-10 flex-1   mt-16",children:e.jsx("div",{className:"w-full max-w-[89rem] mx-auto",children:e.jsxs("div",{className:`\r
              flex\r
							justify-between\r
\r
							flex-col\r
