import{r as w,j as t}from"./radix-CFyMAmnS.js";import{S as M}from"./section-title-JfikkDL4.js";import{u as S}from"./i18n-eAXfqVEm.js";import{L as k,d as E,a as b}from"./motion-mDcWmv0I.js";import"./index-DY3dzlHZ.js";import"./icons-DL-dbEzw.js";function D(){const r=w.useRef(null),u=w.useRef([]),p=w.useRef();return w.useEffect(()=>{const c=r.current;if(!c)return;const s=c.getContext("2d");if(!s)return;let e=0,a=0;const l=.5,o=150,x=60,h=()=>{const i=c.parentElement;if(i){e=c.width=i.offsetWidth,a=c.height=i.offsetHeight,u.current=[];for(let n=0;n<x;n++)u.current.push({x:Math.random()*e,y:Math.random()*a,vx:(Math.random()-.5)*l,vy:(Math.random()-.5)*l})}};h(),window.addEventListener("resize",h);const f=(i,n)=>{const d=i.x-n.x,m=i.y-n.y;return Math.sqrt(d*d+m*m)},g=()=>{const i=u.current;for(let n=0;n<i.length-1;n++)for(let d=n+1;d<i.length;d++){const m=f(i[n],i[d]);if(m<=o){const N=1-m/o;s.strokeStyle=`hsla(177, 100%, 37%, ${N})`,s.lineWidth=Math.pow(1-m/o,1.5)*2,s.beginPath(),s.moveTo(i[n].x,i[n].y),s.lineTo(i[d].x,i[d].y),s.stroke()}}},y=()=>{const i=u.current;for(const n of i)s.beginPath(),s.arc(n.x,n.y,2,0,Math.PI*2),s.fillStyle="hsl(177, 100%, 47%)",s.fill()},v=()=>{const i=u.current;for(const n of i)n.x+=n.vx,n.y+=n.vy,(n.x<0||n.x>e)&&(n.vx*=-1),(n.y<0||n.y>a)&&(n.vy*=-1)},j=()=>{s.clearRect(0,0,e,a),g(),y(),v(),p.current=requestAnimationFrame(j)};return j(),()=>{window.removeEventListener("resize",h),p.current&&cancelAnimationFrame(p.current)}},[]),t.jsx("canvas",{ref:r,className:"absolute inset-0 w-full h-full"})}const T=`// Get the canvas element and set up the 2D context
