import{j as e,r as l}from"./radix-1h7f9VDF.js";import{H as v}from"./heroSection-CzIIxwK5.js";import{L as u,T as N}from"./Index-DDVesznS.js";import{a as k,c as I}from"./index-Cqogz6n0.js";import{m as b,L as T,d as S,a}from"./motion-eszmwozl.js";import{G as h,I as F,S as z}from"./icons-mI2stUsA.js";import{u as H}from"./i18n-Blv0dhYd.js";const P="/My-Portfolio/assets/hero-bg-cX0l4YhF.webp";function p({href:r,icon:o,label:n,platform:t,delay:i=0}){return e.jsxs(e.Fragment,{children:[e.jsx(b.a,{href:r,target:"_blank",rel:"noopener noreferrer","aria-label":n,initial:{opacity:0,y:-15},animate:{opacity:1,y:0},transition:{duration:.4,delay:i},whileTap:{scale:.9},className:k("social-icon",t,"flex h-12 w-12 items-center justify-center rounded-full","border-2 border-transparent bg-[#0f0f0f] text-white","transition-all duration-300 relative overflow-hidden"),children:o}),e.jsx("style",{children:`
        .social-icon {
          background:
      ...
      `})]})}function D({phrases:r,className:o,speed:n=100,deleteSpeed:t=50,pauseTime:i=2e3}){const[f,y]=l.useState(0),[s,m]=l.useState(""),[d,x]=l.useState(!1);return l.useEffect(()=>{const g=r[f]??"";let c=null;const w=window.setTimeout(()=>{d?s.length>0?m(s.slice(0,-1)):(x(!1),y(j=>(j+1)%r.length)):s.length<g.length?m(g.slice(0,s.length+1)):c=window.setTimeout(()=>x(!0),i)},d?t:n);return()=>{window.clearTimeout(w),c&&window.clearTimeout(c)}},[s,d,f,r,n,t,i]),e.jsxs("span",{className:I("inline-block",o),children:[s,e.jsx(b.span,{animate:{opacity:[1,0,1]},transition:{duration:.8,repeat:1/0},className:"ml-1 inline-block w-[3px] h-[1em] bg-primary align-middle"})]})}const G=[{href:"https://github.com",icon:e.jsx(h,{className:"h-6 w-6"}),label:"GitHub",platform:"github"},{href:"https://instagram.com",icon:e.jsx(F,{className:"h-6 w-6"}),label:"Instagram",platform:"instagram"},{href:"https://t.me",icon:e.jsx(z,{className:"h-6 w-6"}),label:"Telegram",platform:"telegram"}];function R(){const{t:r}=H(),o=[r("hero.typewriter.name"),r("hero.typewriter.frontend"),r("hero.typewriter.uiux"),r("hero.typewriter.web3")],n=r("hero.greeting");return e.jsxs(T,{features:S,children:[" ",e.jsxs("section",{className:"relative  flex flex-col overflow-hidden bg-background",children:[e.jsx("div",{className:"absolute inset-0 bg-cover bg-center bg-no-repeat opacity-30",style:{backgroundImage:`url(${P})`}}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-background/30 via-background/60 to-background"}),e.jsx("div",{className:"absolute inset-0 opacity-10",children:e.jsx("div",{className:"absolute inset-0",style:{backgroundImage:`linear-gradient(hsl(var(--primary) / 0.1) 1px, transparent 1px),
                              linear-gradient(90deg, hsl(var(--primary) / 0.1) 1px, transparent 1px)`,backgroundSize:"50px 50px"}})}),e.jsxs(a.header,{initial:{opacity:0,y:-50},animate:{opacity:1,y:0},transition:{duration:.6,delay:1.5},className:"relative z-10 flex items-center justify-between p-4 md:p-8",children:[e.jsx(p,{href:"https://github.com",icon:e.jsx(h,{className:"h-6 w-6"}),label:"GitHub",platform:"github",delay:1.6}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"flex gap-2",children:G.slice(1).map((t,i)=>e.jsx(p,{...t,delay:1.7+i*.1},t.label))}),e.jsx(u,{className:"hidden md:flex items-center"}),e.jsx(u,{className:"md:hidden flex items-center"}),e.jsx(N,{})]})]}),e.jsx("div",{className:"relative z-10 flex-1   mt-16",children:e.jsx("div",{className:"w-full max-w-[89rem] mx-auto",children:e.jsxs("div",{className:`\r
              flex\r
							justify-between\r
\r
							flex-col\r
