import { j as e, r as l } from './radix-1h7f9VDF.js';
import { H as j } from './heroSection-CzIIxwK5.js';
import { L as g, T as v } from './Index-DdWChmj7.js';
import { a as N, c as k } from './index-DgPIJX3V.js';
import { m as u, L as I, d as T, a } from './motion-eszmwozl.js';
import { G as b, I as S, S as F } from './icons-CDuWiGAR.js';
import { u as z } from './i18n-Blv0dhYd.js';
const H = '/My-Portfolio/assets/hero-bg-cX0l4YhF.webp';
function p({ href: r, icon: o, label: n, platform: t, delay: i = 0 }) {
...
function P({ phrases: r, className: o, speed: n = 100, deleteSpeed: t = 50, pauseTime: i = 2e3 }) {
...
const D = [
	...
	{ href: 'https://t.me', icon: e.jsx(F, { className: 'h-6 w-6' }), label: 'Telegram', platform: 'telegram' },
];
function A() {
	const { t: r } = z(),
		o = [
							...
							e.jsxs('div', {
								...
								children: [
									e.jsx('div', {
										...
										children: D.slice(1).map((t, i) => e.jsx(p, { ...t, delay: 1.7 + i * 0.1 }, t.label)),
									}),
										...
										children: [
											...
											e.jsx('div', {
												...
												children: e.jsx('h2', {
													...
													children: e.jsx(P, { phrases: o, speed: 100 }),
												}),
											}),
											e.jsx(a.div, {
												initial: { opacity: 0, y: 15 },
...
export { A as HeroSection, A as default };
