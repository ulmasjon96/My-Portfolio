import{j as e,m as u,c as w,r as l,a as j,G as p,T as v,M as N,I as k,S as I}from"./index-DSexRWl0.js";import{L as T,d as S,m as a}from"./features-animation-BA_w8hZY.js";const F="/My-Portfolio/assets/hero-bg-cX0l4YhF.webp",D="/My-Portfolio/assets/heroSection-DVxjq-e9.webp";function g({href:r,icon:t,label:n,platform:s,delay:o=0}){return e.jsxs(e.Fragment,{children:[e.jsx(u.a,{href:r,target:"_blank",rel:"noopener noreferrer","aria-label":n,initial:{opacity:0,y:-15},animate:{opacity:1,y:0},transition:{duration:.4,delay:o},whileTap:{scale:.9},className:w("social-icon",s,"flex h-12 w-12 items-center justify-center rounded-full","border-2 border-transparent bg-[#0f0f0f] text-white","transition-all duration-300 relative overflow-hidden"),children:t}),e.jsx("style",{children:`
        .social-icon {
          background:
